 ...
 * * File All-In-One Application Suite Terupdate dengan Filter Cetak PDF.
 */

// --- 1. KONFIGURASI DATABASE ---
$host = 'localhost';
$db_user = 'b8_42001405';
$db_pass = 'agungbaitul83';
$db_name = 'b8_42001405_bsi_tasikmalaya';
...
// LOGIKA CETAK PDF TERFILTER KATEGORI STATUS CLOSING / BELUM CLOSING
    ...
    <body onload="window.print()">
        <div class="container my-5" style="max-width: 1000px;">
            <div class="no-print alert alert-info d-flex justify-content-between align-items-center mb-4">
                <span><i class="fa-solid fa-print me-2"></i>Kotak dialog cetak otomatis muncul. Pilih tujuan: <strong>"Save as PDF"</strong> / <strong>"Simpan sebagai PDF"</strong>.</span>
                <a href="?p=bju" class="btn btn-sm btn-secondary fw-bold">Kembali</a>
            </div>
            ...
            <table class="table table-bordered align-middle">
                ...
                <tbody>
                    <?php if (count($all_bju) === 0): ?>
                        <tr>
                            <td colspan="7" class="text-center text-muted py-4">Belum ada entri data siswa yang memenuhi kriteria filter.</td>
                        </tr>
                    <?php else: ?>
            ...
            <div class="mt-5 d-flex justify-content-between align-items-center">
                <div class="text-muted small">Total Data Terpilih: <strong><?= count($all_bju) ?></strong> entri data siswa.</div>
        ...
        <div class="card border-0 shadow-sm rounded-3 mb-4">
            <div class="card-body p-4">
                <form method="GET" class="row g-3">
                    ...
                    <div class="col-md-4">
                        <label class="form-label small fw-bold text-secondary">Status Hubungan</label>
                ...
                <div class="row bg-light p-3 rounded-3 border mb-4 align-items-center">
                    <div class="col-md-6">
                        <form method="GET" class="d-flex align-items-center">
                            ...
                            <label class="fw-bold text-secondary me-2 small text-nowrap">Filter Kategori Berkas:</label>
                    ...
                    <div class="col-md-6 text-md-end mt-2 mt-md-0">
                        <a href="?p=download_format&status=<?= urlencode($sel_status) ?>" target="_blank" class="btn btn-danger fw-bold"><i class="fa-solid fa-file-pdf me-1"></i> Cetak PDF Kategori Ini</a>
                    </div>
                </div>
                    ...
                    <table class="table table-bordered table-hover align-middle small">
                        ...
                        <tbody>
                            <?php if (count($bju_rows) === 0): ?>
                                <tr>
                                    <td colspan="8" class="text-center text-muted py-3">Tidak ada data pendaftaran yang cocok dengan kriteria filter.</td>
                                </tr>
                            <?php else: ?>
                ...
                <div class="modal-dialog">
                    <form method="POST" class="modal-content">
                        ...
                        <div class="modal-body text-start">
                            <div class="mb-3">
                                <label class="form-label small fw-bold">No. Formulir</label>
